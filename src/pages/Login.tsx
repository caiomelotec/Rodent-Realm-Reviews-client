        ...
        <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md dark:bg-slate-600">
            ...
            <form onSubmit={handleSubmit(processForm)}>
              ...
              <div className="flex items-center mb-6 -mt-4">
                <div className="flex ml-auto">
                  <a
                    href="#"
                    className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700 dark:text-white"
                  >
              ...
              <div className="flex w-full">
                <button
                  type="submit"
                  className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in dark:bg-slate-800 dark:hover:bg-slate-700"
                >
          ...
          <div className="flex justify-center items-center mt-6">
            ...
            >
              ...
              <span className="ml-2 text-base">You don't have an account?</span>
            </Link>
          </div>
        </div>
      </div>
